...
describe("ServerDataTableToolbar Logic", () => {
  ...
  describe("UI State Management", () => {
    ...
    it("should handle keyboard shortcuts correctly", () => {
      ...
      expect(handleKeyboardShortcut({ key: '/', ctrlKey: false, metaKey: false })).toBe('focus-search');
      expect(handleKeyboardShortcut({ key: 'Escape', ctrlKey: false, metaKey: false })).toBe('clear-search');
      expect(handleKeyboardShortcut({ key: 'Enter', ctrlKey: false, metaKey: false })).toBe('trigger-search');
