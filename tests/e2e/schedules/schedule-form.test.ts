...
test.describe('Schedule Form Integration', () => {
  ...
  test.describe('Schedule Form Validation', () => {
    ...
    test('should validate schedule name length', async ({ page }) => {
      ...
      await page.click('text=Save');
      await expect(page.locator('text=Schedule name must be less than 30 characters')).toBeVisible();
    });
  ...
  test.describe('Schedule Form Functionality', () => {
    ...
    test('should create range amount schedule successfully', async ({ page }) => {
      ...
      const scheduleRow = page.locator('[data-testid="schedule-row"]:has-text("Variable Utilities")');
    ...
    test('should create approximate amount schedule successfully', async ({ page }) => {
      ...
      const scheduleRow = page.locator('[data-testid="schedule-row"]:has-text("Approximate Groceries")');
  ...
  test.describe('Recurring Date Configuration', () => {
    ...
    test('should configure daily recurrence', async ({ page }) => {
      ...
      const scheduleRow = page.locator('[data-testid="schedule-row"]:has-text("Recurring Schedule")');
  ...
  test.describe('Edit Schedule', () => {
    ...
    test('should open edit dialog', async ({ page }) => {
      const scheduleRow = page.locator('[data-testid="schedule-row"]:has-text("Test Schedule for Edit")');
  ...
  test.describe('Delete Schedule', () => {
    ...
    test('should show delete confirmation dialog', async ({ page }) => {
      const scheduleRow = page.locator('[data-testid="schedule-row"]:has-text("Schedule to Delete")');
      await scheduleRow.locator('[data-testid="schedule-actions"]').click();
      ...
      await expect(page.locator('text=Are you sure you want to delete "Schedule to Delete"?')).toBeVisible();
    });
  ...
  test.describe('Schedule Status Management', () => {
    ...
    test('should toggle schedule status', async ({ page }) => {
      const activeSchedule = page.locator('[data-testid="schedule-row"]:has-text("Active Schedule")');
