...
import { accountDocumentsRouter } from "./routes/account-documents";
import { documentExtractionRouter } from "./routes/document-extraction";
import { accountRoutes } from "./routes/accounts";
import { serverAccountsRoutes } from "./routes/accounts-server";
...
import { categoryAliasRoutes } from "./routes/category-aliases";
import { categoryGroupsRoutes } from "./routes/category-groups";
import { payeeAliasRoutes } from "./routes/payee-aliases";
import { payeeCategoriesRoutes } from "./routes/payee-categories";
import { payeeRoutes } from "./routes/payees";
import { transactionRoutes } from "./routes/transactions";
import { transferMappingRoutes } from "./routes/transfer-mappings";
...
import { homeMaintenanceRoutes } from "./routes/home-maintenance";
import { homeAttachmentsRoutes } from "./routes/home-attachments";
...
export const router = t.router({
  ...
  homeMaintenanceRoutes,
  homeAttachmentsRoutes,
