...
export const DASHBOARD_TEMPLATES: DashboardTemplate[] = [
  {
    id: "home",
    name: "Home",
    description: "Narrative-led overview: monthly brief, forecast, budget pacing, and what's next",
    icon: "home",
    layout: { columns: 4, gap: "normal" },
    widgets: [
      {
        widgetType: "period-brief-narrative",
        size: "full",
        sortOrder: 0,
        columnSpan: 4,
        settings: { period: "week" },
      },
      { widgetType: "total-balance-copilot", size: "small", sortOrder: 1, columnSpan: 1 },
      { widgetType: "cashflow-forecast-copilot", size: "large", sortOrder: 2, columnSpan: 3 },
      { widgetType: "budget-progress-narrative", size: "medium", sortOrder: 3, columnSpan: 2 },
      { widgetType: "spending-insights-coach", size: "medium", sortOrder: 4, columnSpan: 2 },
      { widgetType: "recent-transactions", size: "medium", sortOrder: 5, columnSpan: 2 },
