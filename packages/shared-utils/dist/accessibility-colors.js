 ...
 */
function getBackgroundColor(themeMode) {
    if (!browser)
        return '#ffffff';
 ...
 */
export function calculateOptimalOpacity(colorScheme = 'default', themeMode, targetContrast = 3.0 // WCAG AA standard for graphical elements
) {
 ...
 */
export function getOptimalCrosshairColor(colorScheme = 'default', themeMode) {
    const mode = themeMode || detectThemeMode();
 ...
 */
export function getOptimalGridOpacity(themeMode) {
    const mode = themeMode || detectThemeMode();
 ...
 */
export function getOptimalPointOpacity(colorScheme = 'default', themeMode) {
    const mode = themeMode || detectThemeMode();
...
export function createThemeDetector() {
    ...
    try {
        let currentMode = detectThemeMode();
...
//# sourceMappingURL=accessibility-colors.js.map