 ...
 */
export function generatePeriodOptions(data, dateField) {
    if (!data.length)
 ...
 */
export function getPeriodStartDate(periodKey) {
    if (periodKey === 0 || periodKey === "0")
 ...
 */
export function filterDataByPeriod(data, dateField, periodKey) {
    if (periodKey === 0 || periodKey === "0")
...
//# sourceMappingURL=chart-periods.js.map