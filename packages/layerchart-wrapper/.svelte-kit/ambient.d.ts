...
declare module '$env/static/private' {
	...
	export const LISTMAX: string;
	export const HISTSIZE: string;
	export const NODE: string;
	export const NODE_REPL_HISTORY_SIZE: string;
	...
	export const TRDL_USE_WERF_GROUP_CHANNEL: string;
	...
	export const TERMINUS_ALLOW_UNSUPPORTED_NEWER_PHP: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TRDL_USE_WERF_GROUP_CHANNEL: string;
		...
		PATH: string;
		HISTFILESIZE: string;
		TERMINUS_ALLOW_UNSUPPORTED_NEWER_PHP: string;
