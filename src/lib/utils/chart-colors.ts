 ...
 */
export const CHART_COLOR_SCHEMES: Record<string, ColorScheme> = {
  default: {
    name: "Default",
 ...
 */
export function getColorSchemesByCategory(): Record<string, ColorScheme[]> {
  const grouped: Record<string, ColorScheme[]> = {
    general: [],
    financial: [],
    accessibility: [],
    thematic: [],
 ...
 */
export function getColorScheme(key: string): ColorScheme | null {
 ...
 */
export function getSchemeColors(key: string): string[] {
 ...
 */
export function getAvailableSchemeKeys(): string[] {
