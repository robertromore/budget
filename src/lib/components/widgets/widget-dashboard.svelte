...
// Removed neodrag import - using HTML5 drag and drop for grid-based sorting
  ...
  function getSlotPosition(index: number, gridContainer: HTMLElement) {
...
<div class="space-y-4">
  ...
  >
    ...
    {#if isDragging && isEditMode}
      <div
        class="widget-wrapper drop-zone-end {dragOverDropZone === enabledWidgets.length ? 'drag-over' : ''}"
...
<div class="space-y-4">
  ...
  <div class="widget-grid">
    <div class="bg-gray-100 rounded-lg p-4 min-h-[100px] animate-pulse"></div>
    <div class="bg-gray-100 rounded-lg p-4 min-h-[100px] animate-pulse"></div>
    <div class="bg-gray-100 rounded-lg p-4 min-h-[100px] animate-pulse"></div>
    <div class="bg-gray-100 rounded-lg p-4 min-h-[100px] animate-pulse"></div>
    <div class="bg-gray-100 rounded-lg p-4 min-h-[100px] animate-pulse"></div>
...
<style>
  ...
  .drop-zone-overlay {
    ...
    box-shadow: inset 0 0 12px hsl(var(--primary) / 0.1), 0 2px 8px hsl(var(--foreground) / 0.05);
  }

  .drop-zone-overlay.drag-over {
    background: hsl(var(--widget-active) / 0.25);
    border-color: hsl(var(--widget-active) / 0.8);
    box-shadow: 0 0 0 4px hsl(var(--widget-active) / 0.6), 0 0 30px hsl(var(--widget-active) / 0.7);
  ...
  .drop-zone-text {
    ...
    pointer-events: none;
    z-index: 1001;
    box-shadow: 0 2px 8px hsl(var(--foreground) / 0.1), 0 0 0 1px hsl(var(--background) / 0.8);
  ...
  @keyframes overlay-pulse {
    0%, 100% {
      box-shadow: inset 0 0 20px hsl(var(--primary) / 0.1), 0 4px 12px hsl(var(--primary) / 0.08);
    }
    50% {
      box-shadow: inset 0 0 30px hsl(var(--primary) / 0.2), 0 6px 18px hsl(var(--primary) / 0.15);
    }
  }
