  ...
  <Dialog.Content class="max-w-lg">
    ...
    <form onsubmit={(e) => { e.preventDefault(); handleSubmit(); }} class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        <Select.Root
          type="single"
          bind:value={rolloverMode}
        >
          <Select.Trigger>
            <span>{rolloverModeOptions.find(option => option.value === rolloverMode)?.label}</span>
          </Select.Trigger>
          <Select.Content>
      ...
      <div class="space-y-2">
        ...
        >
          <Select.Trigger>
            <span>{priority} - {["Lowest Priority", "Low Priority", "Medium-Low Priority", "Medium Priority", "Normal Priority", "High Priority", "Highest Priority"][Number(priority) - 1]}</span>
          </Select.Trigger>
          <Select.Content>
      ...
      <div class="space-y-3">
        ...
        {#if isEmergencyFund}
          <p class="text-xs text-muted-foreground ml-6">
            This envelope will be used as a source for deficit recovery and have special priority handling
          </p>
        {/if}
