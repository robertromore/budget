...
describe("Recurring Date Logic", () => {
  describe("Daily Frequency", () => {
    ...
    test("should generate daily dates with interval 2", () => {
      ...
      const expectedDates = ["2024-01-01", "2024-01-03", "2024-01-05", "2024-01-07"];
  ...
  describe("Weekly Frequency", () => {
    test("should generate weekly dates with interval 1", () => {
      ...
      const expectedDates = ["2024-01-01", "2024-01-08", "2024-01-15", "2024-01-22", "2024-01-29"];
    ...
    test("should generate bi-weekly dates", () => {
      ...
      const expectedDates = ["2024-01-01", "2024-01-15", "2024-01-29", "2024-02-12"];
    ...
    test("should handle specific weekdays", () => {
      ...
      const generatedDates = generateWeeklyDatesWithWeekdays(
        startDate,
        endDate,
        interval,
        weekdays
  ...
  describe("Monthly Frequency", () => {
    ...
    test("should generate quarterly dates (interval 3)", () => {
      ...
      const expectedDates = ["2024-01-15", "2024-04-15", "2024-07-15", "2024-10-15"];
  ...
  describe("Yearly Frequency", () => {
    test("should generate yearly dates", () => {
      ...
      const expectedDates = ["2024-03-15", "2025-03-15", "2026-03-15", "2027-03-15"];
    ...
    test("should generate dates with multi-year interval", () => {
      ...
      const expectedDates = ["2024-01-01", "2026-01-01", "2028-01-01", "2030-01-01"];
...
function generateDailyDatesWithLimit(
  startDate: Date,
  endDate: Date,
  interval: number,
  limit: number
...
function generateWeeklyDatesWithWeekdays(
  startDate: Date,
  endDate: Date,
  interval: number,
  weekdays: number[]
