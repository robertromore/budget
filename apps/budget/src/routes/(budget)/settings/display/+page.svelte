...
const headerActionsModeOptions = [
  {
    value: 'off',
    label: 'Keep on page',
    description: 'Action buttons appear on their respective pages',
  },
  {
    value: 'secondary',
    label: 'Secondary to header',
    description: 'Move utility buttons (Analytics, Management) to header',
  },
  {
    value: 'all',
    label: 'All to header',
    description: 'Move all action buttons including primary actions to header',
  },
] as const;
...
const headerActionsDisplayOptions = [
  {
    ...
    description: 'Show both icon and label on header action buttons',
  },
  {
    value: 'icon-only',
    label: 'Icon only',
    description: 'Show only icons on header action buttons (hover for label)',
  },
] as const;
...
const headerTabsModeOptions = [
  { value: 'off', label: 'Keep on page', description: 'Tabs appear within the page content' },
  {
    ...
    description: 'Tabs appear in the app header for a cleaner page layout',
  },
] as const;
...
const headerTabsDisplayOptions = [
  {
    value: 'icon-text',
    label: 'Icon with text',
    description: 'Show both icon and label on header tabs',
  },
  {
    value: 'icon-only',
    label: 'Icon only',
    description: 'Show only icons on header tabs (hover for label)',
  },
] as const;
...
const tableDisplayModeOptions = [
  {
    value: 'popover',
    label: 'Popup dropdown',
    description: 'Compact popover with collapsible sections',
  },
  {
    value: 'sheet',
    label: 'Responsive sheet',
    description: 'Side panel on desktop, drawer on mobile with more space',
  },
] as const;
...
const notificationModeOptions = [
  {
    value: 'toast',
    label: 'Toast popups',
    description: 'Show notifications as temporary popups in the corner of the screen',
  },
  {
    value: 'popover',
    label: 'Notification center',
    description: 'Collect notifications in a bell icon popover for later review',
  },
] as const;
...
const notificationVerbosityOptions = [
  {
    ...
    description: 'Show all success, warning, and error notifications',
  },
  {
    value: 'important',
    label: 'Important only',
    description: 'Show errors, warnings, and important operations only',
  },
...
<div class="space-y-6" data-help-id="settings-display" data-help-title="Display Settings">
  <div>
    ...
    <p class="text-muted-foreground text-sm">
      Configure how dates, numbers, and currency are displayed
    </p>
  </div>
  ...
  <Card.Root data-help-id="display-number-format" data-help-title="Number Format">
    <Card.Header>
      ...
      <Card.Description
        >Choose how numbers are formatted (thousands separator, decimal)</Card.Description>
    </Card.Header>
    <Card.Content>
  ...
  <Card.Root data-help-id="display-header-tabs" data-help-title="Header Tabs Mode">
    <Card.Header>
      ...
      <Card.Description
        >Move page navigation tabs to the header for a cleaner layout</Card.Description>
    </Card.Header>
    <Card.Content>
      <div class="space-y-3">
