    ...
    {:else}
      <Card.Root>
        <Card.Header class="text-center">
          ...
          <Card.Description>You've been invited to join a workspace</Card.Description>
        </Card.Header>
        <Card.Content class="space-y-6">
            ...
            <div class="space-y-3">
              <div>
                ...
                <p class="text-lg font-semibold">
                  {invitation.workspace.displayName ||
          ...
          {#if !isLoggedIn}
            <div
              class="rounded-md bg-amber-50 p-3 text-sm text-amber-800 dark:bg-amber-950/30 dark:text-amber-200">
