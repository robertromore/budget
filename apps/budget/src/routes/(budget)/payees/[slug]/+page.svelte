...
const suggestionsQuery = $derived(
  payee?.id && activeTab === 'analytics' ? rpc.payees.getPayeeSuggestions(payee.id).options() : null
);
              ...
              <section class="rounded-lg border p-5">
                ...
                <div class="h-56">
                  <LayerCake
                    ...
                    x="timestamp"
                    y="displayAmount"
                    xDomain={[minDate - chartDateRange * 0.05, maxDate + chartDateRange * 0.05]}
                ...
                <div class="mt-3 flex flex-wrap items-center justify-center gap-4 text-xs">
                  <div class="flex items-center gap-1.5">
                    <div class="h-3 w-3 rounded-full" style="background-color: var(--chart-1);">
                    </div>
                    <span>Expense</span>
                  </div>
                  <div class="flex items-center gap-1.5">
                    <div class="h-3 w-3 rounded-full" style="background-color: var(--chart-3);">
                    </div>
                    <span>Income</span>
                  </div>
                  <div class="flex items-center gap-1.5">
