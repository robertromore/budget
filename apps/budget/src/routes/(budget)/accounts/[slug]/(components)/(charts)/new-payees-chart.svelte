...
const summaryStats = $derived.by(() => {
  ...
  return [
    {
      label: 'Total New Payees',
      value: totalNew.toString(),
      description: `in ${monthlyNewPayees.length} months`,
    },
  ...
  return {
    ...
    distribution: {
      highest: {
        ...
        monthLabel: `${peakMonth.count} new payees`,
      },
      lowest: {
        value: lowestMonth.count,
        month: lowestMonth.monthLabel,
        monthLabel: `${lowestMonth.count} new payees`,
      },
