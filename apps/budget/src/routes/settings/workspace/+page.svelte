...
const canManageMembers = $derived(myMembership?.role === 'owner' || myMembership?.role === 'admin');
  ...
  <AlertDialog.Content>
    <AlertDialog.Header>
      ...
      <AlertDialog.Description>
        Are you sure you want to remove <strong>{memberToRemove?.name}</strong> from this workspace? They
        will lose access to all workspace data.
      </AlertDialog.Description>
    </AlertDialog.Header>
    <AlertDialog.Footer>
