      ...
      <Card.Content class="pt-6">
        <div class="space-y-3">
          ...
          <ul class="text-muted-foreground space-y-1 text-xs">
            <li>
              * <strong>SimpleFIN</strong> - Subscribe at simplefin.org ($15/year). Save your Access URL
              here or enter it when connecting each account.
            </li>
            <li>
              * <strong>Teller</strong> - Get a free developer account at teller.io (100 connections).
              Configure Application ID above.
            </li>
