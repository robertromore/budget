...
const passphraseValid = $derived(
  keyType !== 'passphrase' || (passphrase.length >= 12 && passphrase === confirmPassphrase)
);
</script>
      ...
      <Card.Root>
        ...
        <Card.Footer>
          <Button
            ...
            disabled={!hasChanges || updatePrefsMutation.isPending}>
          ...
          {:else}
            <div class="space-y-4">
              <div class="space-y-3">
                ...
                <RadioGroup.Root bind:value={keyType} class="space-y-2">
                  <label
                    ...
                    class:border-primary={keyType === 'token'}>
                  ...
                  <label
                    class="hover:bg-muted/50 flex cursor-pointer items-center gap-3 rounded-md border p-3"
                    class:border-primary={keyType === 'passphrase'}>
                  ...
                  <label
                    class="hover:bg-muted/50 flex cursor-pointer items-center gap-3 rounded-md border p-3"
                    class:border-primary={keyType === 'keypair'}>
              ...
              <Button
                ...
                disabled={!passphraseValid || generateKeyMutation.isPending}>
                <Key class="mr-2 h-4 w-4" />
                ...
                <div class="flex items-center justify-between rounded-lg border p-3">
                  <div class="flex items-center gap-3">
                    <div class="bg-muted flex h-10 w-10 items-center justify-center rounded-full">
                      {#if device.label?.toLowerCase().includes('phone') || device.label
                          ?.toLowerCase()
                          .includes('mobile')}
