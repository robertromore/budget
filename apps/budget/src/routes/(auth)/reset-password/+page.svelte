...
<Card.Root>
  ...
  <Card.Content>
    {#if !token}
      <div class="space-y-4 text-center">
        <p class="text-destructive text-sm">Invalid or missing password reset link.</p>
        <Button variant="outline" href="/forgot-password" class="w-full">Request a new link</Button>
      </div>
    {:else}
  ...
  <Card.Footer class="justify-center">
    <a href="/login" class="text-muted-foreground hover:text-foreground text-sm"> Back to login </a>
  </Card.Footer>
</Card.Root>
