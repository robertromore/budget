              ...
              <Table.Row>
                ...
                <Table.Cell>
                  <Input
                    ...
                    value={tier.usageMin}
                    oninput={(e) =>
                      updateTier(index, 'usageMin', parseFloat(e.currentTarget.value) || 0)}
                    min="0"
                    step="1"
                    class="h-8"
                    disabled={index > 0} />
                ...
                <Table.Cell>
                  <div class="flex items-center gap-1">
                    ...
                    <Input
                      ...
                      oninput={(e) =>
                        updateTier(index, 'ratePerUnit', parseFloat(e.currentTarget.value) || 0)}
                      min="0"
                      step="0.001"
                      class="h-8" />
                  </div>
        ...
        <Table.Body>
          {#each rateTiers as tier}
            <Table.Row>
              ...
              <Table.Cell>
                {tier.usageMin.toLocaleString()} - {tier.usageMax
                  ? tier.usageMax.toLocaleString()
                  : '+'}
                {usageUnit}
              </Table.Cell>
