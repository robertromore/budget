  ...
  <AlertDialog.Content class="max-w-lg">
    <AlertDialog.Header>
      ...
      <AlertDialog.Description class="pt-2">
        This will merge {duplicatePayees.length} duplicate payee{duplicatePayees.length === 1
          ? ''
          : 's'} into <strong>{primaryPayee?.name}</strong>.
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-muted-foreground text-xs">Fill empty fields from duplicate payees</p>
            </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-muted-foreground text-xs">Combine ML/AI insights from all payees</p>
            </div>
