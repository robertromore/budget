...
<div class="space-y-6 {className}">
  ...
  <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
    ...
    <Card.Root>
      <Card.Content class="p-6">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-muted-foreground text-sm font-medium">Total Payees</p>
    ...
    <Card.Root>
      <Card.Content class="p-6">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-muted-foreground text-sm font-medium">Selected</p>
            <p class="text-2xl font-bold">{selectedCount}</p>
          </div>
          <CircleCheck class="text-muted-foreground h-8 w-8" />
        </div>
        {#if hasSelection}
          <div class="mt-2">
        ...
        {:else}
          <p class="text-muted-foreground mt-2 text-xs">No payees selected</p>
        {/if}
      </Card.Content>
    </Card.Root>
    ...
    <Card.Root>
      <Card.Content class="p-6">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-muted-foreground text-sm font-medium">Data Health</p>
            <p class="text-2xl font-bold {getHealthScoreColor(systemHealth.score)}">
              {systemHealth.score}%
            </p>
          </div>
          <TrendingUp class="text-muted-foreground h-8 w-8" />
        </div>
    ...
    <Card.Root>
      <Card.Content class="p-6">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-muted-foreground text-sm font-medium">Recent Ops</p>
        ...
        {:else}
          <p class="text-muted-foreground mt-2 text-xs">No recent operations</p>
        {/if}
      </Card.Content>
    </Card.Root>
  </div>
  ...
  <Tabs.Root bind:value={activeTab} class="space-y-4">
    ...
    <Tabs.Content value="list" class="space-y-4">
      <PayeeListWithSelection showBulkOperations={true} showFilters={true} showStats={true} />
    </Tabs.Content>
