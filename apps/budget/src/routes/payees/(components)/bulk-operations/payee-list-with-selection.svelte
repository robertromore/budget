        ...
        <div class="flex flex-col gap-4 lg:flex-row">
          ...
          <div class="flex-1">
            <div class="relative">
              ...
              <Input bind:value={searchQuery} placeholder="Search payees..." class="pl-10" />
            </div>
          </div>

          <!-- Filters -->
          <div class="flex gap-2">
            <select bind:value={filterType} class="rounded-md border px-3 py-2 text-sm">
    ...
    <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
      <Card.Root>
        <Card.Content class="p-4 text-center">
          ...
          <div class="text-muted-foreground text-sm">Total Payees</div>
        </Card.Content>
      </Card.Root>
      <Card.Root>
        <Card.Content class="p-4 text-center">
          <div class="text-2xl font-bold">{filteredPayees.length}</div>
          <div class="text-muted-foreground text-sm">Filtered</div>
        </Card.Content>
      </Card.Root>
      <Card.Root>
        <Card.Content class="p-4 text-center">
          <div class="text-2xl font-bold">{selectedCount}</div>
          <div class="text-muted-foreground text-sm">Selected</div>
        </Card.Content>
      </Card.Root>
      <Card.Root>
        <Card.Content class="p-4 text-center">
            ...
            <Table.Cell>
              <div class="flex items-center gap-2">
                ...
                <div>
                  ...
                  {#if payee.notes}
                    <div class="text-muted-foreground max-w-xs truncate text-sm">{payee.notes}</div>
                  {/if}
                </div>
              </div>
            </Table.Cell>
            ...
            <Table.Cell>
              <DropdownMenu.Root>
                ...
                <DropdownMenu.Content align="end">
                  ...
                  <DropdownMenu.Item onclick={() => handlePayeeDelete(payee)} class="text-red-600">
    ...
    {#if totalPages > 1}
      <div class="flex items-center justify-between p-4">
        <div class="text-muted-foreground text-sm">
          ...
          )} of {filteredPayees.length} payees
        </div>
        <div class="flex gap-2">
          <Button
            variant="outline"
