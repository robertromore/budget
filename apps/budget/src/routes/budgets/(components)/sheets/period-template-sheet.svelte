...
<ResponsiveSheet bind:open {onOpenChange}>
  {#snippet header()}
    ...
    <Sheet.Description>
      Budget periods are time windows (like January 2025, Q1 2025, or Week 1) that organize your spending into manageable chunks. This automation creates these periods on a schedule—weekly, monthly, quarterly, or yearly—so you can track spending patterns over time, compare period-to-period performance, and maintain consistent budgeting habits without manual setup.
    </Sheet.Description>
  {/snippet}
