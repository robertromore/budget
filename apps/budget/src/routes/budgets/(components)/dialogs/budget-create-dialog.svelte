...
const availableCategories = $derived.by(() =>
  Array.from(categoriesState.categories.values()).sort((a, b) =>
...
const isFormValid = $derived.by(() => {
  ...
  const hasCategories = currentBudgetConfig.requiresCategories
...
async function handleSubmit() {
  ...
  try {
    ...
    const budgetData: CreateBudgetRequest = {
      ...
      metadata,
      ...(currentBudgetConfig.requiresAccounts && {
        accountIds: selectedAccountIds.map((id) => Number(id)),
      }),
      ...(currentBudgetConfig.requiresCategories && {
  ...
  {#snippet content()}
    <WizardFormWrapper
      ...
      subtitle={isEditing
        ...
        : 'Set up spending limits and track your financial goals'}
      ...
      {#snippet formContent()}
        <form
          ...
          <div class="space-y-2">
            ...
            <Select.Root type="single" bind:value={selectedBudgetType}>
          ...
          <div class="space-y-2">
            ...
            <Select.Root type="single" bind:value={periodType}>
          ...
          <div class="space-y-2">
            ...
            <Input
              ...
              bind:value={startDay}
              placeholder={periodType === 'monthly'
                ? '1-31'
                : periodType === 'weekly'
                  ? '1-7 (1=Monday)'
                  : '1-366'} />
