...
<div class={cn('space-y-6', className)}>
  ...
  <Card.Root>
    <Card.Header>
      ...
      <Card.Description>
        Drag and drop to move funds between budget envelopes. Only envelopes with available funds
        can be dragged.
      </Card.Description>
    </Card.Header>
  </Card.Root>
        ...
        {#each activeEnvelopes as envelope (envelope.id)}
          ...
          <div
            ...
            <div class="mb-3 flex items-center gap-3">
              ...
              {#if canDrag}
                <Badge variant="secondary" class="text-xs">Draggable</Badge>
              {:else}
                <Badge variant="outline" class="text-xs">Empty</Badge>
              {/if}
            </div>
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between">
                <span class="font-medium text-emerald-600 dark:text-emerald-400">Available:</span>
            ...
            {#if canDrag}
              <div class="mt-3 rounded bg-emerald-100 p-2 text-center dark:bg-emerald-900/50">
            ...
            <div class="bg-background flex items-center justify-between rounded-md border p-3">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-muted-foreground text-xs">{envelope.type}</p>
                </div>
              </div>
  ...
  <Dialog.Content class="max-w-md" interactOutsideBehavior="ignore">
    ...
    {#if sourceBudget && targetBudget}
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          <div class="bg-muted/50 flex items-center gap-2 rounded-lg p-3">
            ...
            <ArrowRightLeft class="text-muted-foreground h-4 w-4" />
            <div class="flex-1 text-right">
              <p class="text-sm font-medium">To: {targetBudget.name}</p>
              <p class="text-muted-foreground text-xs">{targetBudget.type}</p>
            </div>
          </div>
        </div>
      ...
      <Dialog.Footer class="flex gap-2">
        <Button variant="outline" onclick={cancelTransfer} disabled={isTransferring}>Cancel</Button>
        <Button
