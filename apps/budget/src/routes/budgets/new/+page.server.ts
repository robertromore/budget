  ...
  default: async (event) => {
    ...
    try {
      ...
      const budgetData = {
        ...
        ...(form.data.accountAssociations && { accountAssociations: form.data.accountAssociations }),
        ...
        scheduleMode: form.data.scheduleMode || "link",
        linkedScheduleId: form.data.linkedScheduleId,
        newSchedule: form.data.newSchedule,
      };
