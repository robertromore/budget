 ...
 */
export type EntityType = "transaction" | "account" | "payee" | "category" | "schedule" | "budget";
...
export const triggerEvents: Record<EntityType, TriggerEvent[]> = {
  transaction: [
    {
      ...
      event: "created",
      label: "Created",
      description: "New transaction added (manual, import, or scheduled)",
    },
    {
      entityType: "transaction",
      event: "updated",
      label: "Updated",
      description: "Transaction fields modified",
    },
    {
      entityType: "transaction",
      event: "deleted",
    ...
    },
    {
      ...
      event: "imported",
      label: "Imported",
      description: "Transaction created via import",
    },
    {
      entityType: "transaction",
      event: "categorized",
      label: "Categorized",
      description: "Category assigned to transaction",
    },
    {
      entityType: "transaction",
      event: "cleared",
      label: "Cleared",
      description: "Status changed to cleared",
    },
  ],
  account: [
    ...
    },
    {
      ...
      description: "Balance updated after transaction",
    },
    {
      entityType: "account",
      event: "reconciled",
      label: "Reconciled",
      description: "Account marked as reconciled",
    },
  ],
  payee: [
    { entityType: "payee", event: "created", label: "Created", description: "New payee added" },
    {
      ...
      event: "updated",
      label: "Updated",
      description: "Payee details changed",
    },
    {
      entityType: "payee",
      event: "merged",
      label: "Merged",
      description: "Payee merged with another",
    },
  ],
  category: [
    {
    ...
    },
    {
      ...
      event: "updated",
      label: "Updated",
      description: "Category details changed",
    },
    {
      entityType: "category",
      event: "spendingThresholdReached",
      label: "Spending Threshold",
      description: "Monthly spending hits threshold",
    },
  ],
  schedule: [
    {
    ...
    },
    {
      ...
      event: "due",
      label: "Due",
      description: "Scheduled occurrence is due",
    },
    {
      entityType: "schedule",
      event: "executed",
      label: "Executed",
      description: "Auto-add created transaction",
    },
    {
      entityType: "schedule",
      event: "skipped",
  ...
  budget: [
    { entityType: "budget", event: "created", label: "Created", description: "New budget added" },
    {
      ...
      event: "updated",
      label: "Updated",
      description: "Budget settings changed",
    },
    {
      entityType: "budget",
      event: "overspent",
      label: "Overspent",
      description: "Spending exceeded budget",
    },
    {
      entityType: "budget",
      event: "threshold",
      label: "Threshold Reached",
      description: "Spending hit warning threshold",
    },
    {
      entityType: "budget",
      event: "periodReset",
      label: "Period Reset",
      description: "New budget period started",
    },
  ],
};
...
export const conditionFields: Record<EntityType, ConditionField[]> = {
  transaction: [
    ...
    },
    {
      ...
      label: "Date",
      type: "date",
      operators: ["equals", "before", "after", "between", "dayOfWeek", "dayOfMonth"],
    },
    {
      field: "status",
      label: "Status",
      ...
      enumValues: ["cleared", "pending", "scheduled"],
    },
    {
      field: "notes",
      label: "Notes",
      type: "string",
      operators: ["contains", "startsWith", "endsWith", "matches", "isEmpty", "isNull"],
    },
    {
      field: "payeeId",
      label: "Payee",
      type: "reference",
      operators: ["equals", "notEquals", "isNull", "in"],
      referenceType: "payee",
    },
    {
      field: "payee.name",
    ...
    },
    {
      ...
      label: "Category",
      type: "reference",
      operators: ["equals", "notEquals", "isNull", "in", "inGroup"],
  ...
  account: [
    ...
    },
    {
      ...
      type: "enum",
      operators: ["equals", "notEquals", "in"],
      enumValues: ["checking", "savings", "credit", "cash", "investment", "loan", "other"],
    },
    {
      field: "name",
      label: "Name",
  ...
  payee: [
    ...
    },
    {
      ...
      type: "number",
      operators: ["equals", "greaterThan", "lessThan", "greaterThanOrEquals", "lessThanOrEquals"],
    },
    {
      field: "defaultCategoryId",
      label: "Default Category",
      type: "reference",
      operators: ["equals", "notEquals", "isNull"],
      referenceType: "category",
    },
  ...
  category: [
    ...
    },
    {
      ...
      type: "reference",
      operators: ["equals", "notEquals", "in"],
      referenceType: "categoryGroup",
    },
    {
      field: "monthlyTotal",
      label: "Monthly Total",
      type: "number",
      operators: ["greaterThan", "lessThan", "greaterThanOrEquals", "lessThanOrEquals", "between"],
    },
  ...
  schedule: [
    ...
    },
    {
      ...
      type: "enum",
      operators: ["equals", "in"],
      enumValues: ["daily", "weekly", "biweekly", "monthly", "quarterly", "yearly"],
    },
    {
  ...
  budget: [
    {
      ...
      type: "enum",
      operators: ["equals"],
      enumValues: ["account-monthly", "category-envelope", "goal-based"],
    },
    {
      field: "spent",
      label: "Spent",
...
export const operatorInfo: Record<ConditionOperator, OperatorInfo> = {
  equals: {
    operator: "equals",
    label: "equals",
    description: "Exactly matches value",
    valueCount: 1,
  },
  notEquals: {
    operator: "notEquals",
  ...
  in: {
    operator: "in",
    label: "is one of",
    description: "Is one of the listed values",
    valueCount: 1,
    valueType: "array",
  },
  inGroup: {
    operator: "inGroup",
    label: "is in group",
    description: "Category is in group",
    valueCount: 1,
  },
  isNull: {
    operator: "isNull",
    label: "is empty",
    description: "Value is null/undefined",
    valueCount: 0,
  },
  isEmpty: {
    operator: "isEmpty",
    label: "is blank",
    description: "String is empty or whitespace",
    valueCount: 0,
  },
  before: {
    operator: "before",
  ...
  within: {
    operator: "within",
    label: "within",
    description: "Date is within N days",
    valueCount: 1,
    valueType: "number",
  },
  dayOfWeek: {
    operator: "dayOfWeek",
    label: "day of week",
    description: "Day of week matches",
    valueCount: 1,
    valueType: "array",
  },
  dayOfMonth: {
    operator: "dayOfMonth",
    label: "day of month",
    description: "Day of month matches",
    valueCount: 1,
    valueType: "number",
  },
};
...
export const actionDefinitions: ActionDefinition[] = [
  // Transaction actions
  {
    type: "setCategory",
    label: "Set Category",
    description: "Assign a specific category",
  ...
  },
  {
    type: "setPayee",
    label: "Set Payee",
    description: "Assign a specific payee",
    entityTypes: ["transaction"],
    params: [
      {
        name: "payeeId",
  ...
  },
  {
    ...
    description: "Add text to notes field",
    entityTypes: ["transaction"],
  ...
  },
  {
    type: "setNotes",
    label: "Set Notes",
    description: "Replace notes field",
    entityTypes: ["transaction"],
    params: [{ name: "text", label: "Text", type: "string", required: true }],
  },
  {
  ...
  },
  {
    ...
    description: "Allocate to specific budget",
    entityTypes: ["transaction"],
    params: [
      {
        name: "budgetId",
  ...
  {
    type: "createPayeeAlias",
    label: "Create Payee Alias",
    description: "Create payee alias mapping",
    entityTypes: ["transaction"],
    params: [
      {
        name: "payeeId",
  ...
  },
  {
    ...
    label: "Create Category Alias",
    description: "Create category alias mapping",
    entityTypes: ["transaction"],
    params: [
      {
        name: "categoryId",
  ...
  {
    type: "setAccountDefaultCategory",
    label: "Set Default Category",
    description: "Set default transaction category",
    entityTypes: ["account"],
    params: [
      {
        name: "categoryId",
  ...
  },
  {
    type: "closeAccount",
    label: "Close Account",
    description: "Mark account as closed",
    entityTypes: ["account"],
    params: [],
  },
  ...
  // Payee actions
  {
    type: "setPayeeDefaultCategory",
    label: "Set Default Category",
    description: "Set default category for payee",
    entityTypes: ["payee"],
    params: [
      {
        name: "categoryId",
  ...
  {
    type: "setIsSubscription",
    label: "Set Subscription",
    description: "Mark as subscription",
    entityTypes: ["payee"],
    params: [{ name: "isSubscription", label: "Is Subscription", type: "boolean", required: true }],
  },
  {
    type: "mergePayee",
    label: "Merge With",
    description: "Merge into another payee",
    entityTypes: ["payee"],
    params: [
      {
        name: "targetPayeeId",
  ...
  {
    type: "createPayeeAliasFromPayee",
    label: "Create Alias",
    description: "Add alias for this payee",
    entityTypes: ["payee"],
    params: [{ name: "aliasName", label: "Alias Name", type: "string", required: true }],
  },

  // Category actions
  {
    type: "setCategoryHidden",
    label: "Set Hidden",
    description: "Hide/unhide category",
    entityTypes: ["category"],
    params: [{ name: "isHidden", label: "Hidden", type: "boolean", required: true }],
  },
  {
    type: "setCategoryTaxDeductible",
    label: "Set Tax Deductible",
    description: "Mark as tax deductible",
    entityTypes: ["category"],
    params: [{ name: "isTaxDeductible", label: "Tax Deductible", type: "boolean", required: true }],
  },
  {
    type: "moveCategoryToGroup",
    label: "Move to Group",
  ...
  // Schedule actions
  {
    type: "enableScheduleAutoAdd",
    label: "Enable Auto Add",
    description: "Enable/disable auto-add",
    entityTypes: ["schedule"],
    params: [{ name: "autoAdd", label: "Auto Add", type: "boolean", required: true }],
  },
  {
    type: "skipSchedule",
    label: "Skip",
    description: "Skip next occurrence",
    entityTypes: ["schedule"],
    params: [{ name: "reason", label: "Reason", type: "string", required: false }],
  },
  {
    type: "adjustScheduleAmount",
    label: "Adjust Amount",
    description: "Update scheduled amount",
    entityTypes: ["schedule"],
    params: [{ name: "amount", label: "Amount", type: "number", required: true }],
  },
  {
    type: "pauseSchedule",
    label: "Pause",
  ...
  },
  {
    type: "resumeSchedule",
    label: "Resume",
    description: "Resume paused schedule",
    entityTypes: ["schedule"],
    params: [],
  },
  ...
  // Budget actions
  {
    type: "adjustBudgetLimit",
    label: "Adjust Limit",
    description: "Change budget limit",
    entityTypes: ["budget"],
    params: [{ name: "amount", label: "Amount", type: "number", required: true }],
  },
  {
    ...
    description: "Carry unused to next period",
    entityTypes: ["budget"],
    params: [],
  },
  {
    type: "pauseBudget",
    label: "Pause Budget",
    description: "Pause budget tracking",
    entityTypes: ["budget"],
    params: [],
  },
  ...
  // Universal actions
  {
    ...
    entityTypes: ["transaction", "account", "payee", "category", "schedule", "budget"],
    params: [{ name: "message", label: "Message", type: "string", required: true }],
  },
];
...
export function getActionsForEntity(entityType: EntityType): ActionDefinition[] {
  return actionDefinitions.filter((action) => action.entityTypes.includes(entityType));
}
