---
title: Expand Rows
description: View grouped transaction details
related: [transaction-table, transaction-selection]
---

# Expand/Collapse Rows

Expand grouped rows to see individual transactions within a group.
...
- Expand to see individual transaction details
- Grouped totals help identify spending patterns
- Use with filters for focused analysis
- Collapse to reduce visual clutter
- Keyboard: Arrow keys navigate groups
