...
description: Control how strictly your budget is enforced
related: [budget-type-field, budget-amount-field]
---

# Budget Enforcement

Choose how the app handles budget limits and overspending.
...
- Recommended for: New categories, analysis
...
- Start with Tracking to understand spending patterns
- Move to Flexible once you have baseline data
- Use Strict only for categories you want to limit firmly
- Combine enforcement with automation rules for power users
