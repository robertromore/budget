...
description: Enable individual machine learning capabilities
related: [settings-ml, ml-master-toggle]
---

# ML Feature Toggles

Choose which machine learning features to enable.
...
- Enable all features for the best experience
- Disable individual features you don't need
