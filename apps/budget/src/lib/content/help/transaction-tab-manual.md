...
The fastest way to add transactions when you know all the details.
...
- Payee suggestions improve as you use the app
- Categories can auto-fill based on payee defaults
- Leave budget empty if not tracking spending limits
- Use notes for receipt numbers or memo details
