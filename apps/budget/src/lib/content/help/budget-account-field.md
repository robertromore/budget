...
description: Link your budget to specific accounts
related: [budget-type-field, budget-category-field]
---

# Budget Account

Select which accounts this budget tracks transactions from.
...
- Credit cards work well for tracking category spending
- Savings accounts pair naturally with goal budgets
- Leave blank if you want to track a category regardless of which account pays
