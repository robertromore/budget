...
Manage your saved import profiles for quickly importing transactions from
different banks and sources.

## What Are Import Profiles?

Import profiles save your column mapping configurations so you don't have to set
them up each time you import from the same source.
...
A descriptive name for this import source (e.g., "Chase Checking", "Amex Gold
Card").

### Column Mappings

The saved column positions for each field. These are set during import and
...
- Use `*` as a wildcard
- Example: `chase_*.csv` matches any file starting with "chase\_"
...
Remove profiles you no longer need. This doesn't affect previously imported
transactions.
