---
title: Budget Template Picker
description: Browse and select from pre-built budget templates
type: modal
related:
  - template-search
...
- **Suggested amount** - A recommended starting amount
- **Enforcement level** - How strictly the budget is enforced

## Tips

- Enable help mode (click the ? button) to learn about specific sections
- You can still customize any template after selecting it
- If no template fits your needs, click "Create Custom Budget" at the bottom
