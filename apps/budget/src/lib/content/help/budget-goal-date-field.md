...
description: Set your savings deadline
related: [budget-goal-target-field, budget-type-field]
---

# Goal Target Date

Set when you want to reach your savings goal.
...
- Buffer time for unexpected setbacks
...
- Set dates slightly before actual deadlines
