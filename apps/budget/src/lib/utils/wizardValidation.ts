...
export const scheduleValidations: StepValidation[] = [
  ...
  },
  {
    ...
    rules: [
      {
        field: "payeeId",
        validator: validators.custom("Payee", (value) => value > 0, "Please select a payee"),
      },
    ],
  },
  {
    ...
    rules: [
      {
        field: "accountId",
        validator: validators.custom("Account", (value) => value > 0, "Please select an account"),
      },
    ],
...
export const budgetValidations: StepValidation[] = [
  {
    ...
    rules: [
      {
        field: "type",
        validator: validators.oneOf("Budget type", [
          "account-monthly",
          "category-envelope",
          "goal-based",
          "scheduled-expense",
      ...
      },
      {
        ...
        validator: validators.oneOf("Enforcement level", ["none", "warning", "strict"]),
      },
    ],
  },
  {
