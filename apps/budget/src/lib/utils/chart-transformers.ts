 ...
 */
export function transformDataForChartType(
  data: any[],
  chartType: ChartType,
  options: {
...
function transformForPieChart(
  data: any[],
  options: {categoryField: string; valueField: string; colors: string[]}
) {
 ...
 */
function transformForCalendarChart(data: any[], options: any) {
 ...
 */
export function getDataAccessorsForChartType(chartType: ChartType) {
  switch (chartType) {
    case "pie":
    case "arc":
...
export function supportsMultiSeries(chartType: ChartType): boolean {
  const multiSeriesTypes: ChartType[] = [
    "bar",
    "area",
    "line",
    "scatter",
...
export function isCircularChart(chartType: ChartType): boolean {
  const circularTypes: ChartType[] = ["pie", "arc"]; // Future: 'sunburst'
 ...
 */
export function requiresHierarchicalData(chartType: ChartType): boolean {
  const hierarchyTypes: ChartType[] = []; // Future: 'pack', 'tree', 'treemap', 'sunburst', 'partition'
 ...
 */
export function recommendChartTypes(data: any[]): ChartType[] {
