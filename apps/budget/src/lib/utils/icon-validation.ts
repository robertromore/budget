...
export const VALID_ICON_NAMES = [
  // Finance & Banking
  "credit-card", "piggy-bank", "landmark", "wallet", "banknote", "receipt",
  "trending-up", "trending-down", "dollar-sign", "euro", "pound-sterling",

  // Transportation
  "car", "plane", "train", "bus", "bike", "fuel",

  // Food & Dining
  "coffee", "utensils-crossed", "pizza", "shopping-cart", "apple",

  // Entertainment & Lifestyle
  "gamepad-2", "music", "film", "camera", "book", "dumbbell", "shirt",

  // Home & Utilities
  "home", "lightbulb", "wifi", "phone", "tv", "wrench",
