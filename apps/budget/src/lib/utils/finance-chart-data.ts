 ...
 */
export function transformBalanceHistory(data: BalanceHistoryItem[]): ChartDataPoint[] {
 ...
 */
export function transformCategoryData(categories: CategorySummaryItem[]): ChartDataPoint[] {
 ...
 */
export function transformMonthlyData(data: MonthlyDataItem[]): {
