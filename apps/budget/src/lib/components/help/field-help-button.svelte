...
<Tooltip.Root>
  <Tooltip.Trigger
    type="button"
    class={cn(
      'text-muted-foreground hover:text-foreground focus-visible:ring-ring rounded-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
      className
    )}
    onclick={handleClick}>
