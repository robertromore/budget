...
<DropdownMenu.Root bind:open={dropdownOpen}>
  ...
  <DropdownMenu.Content align="end" class="w-56">
    ...
    <DropdownMenu.Group>
      <DropdownMenu.Item onclick={handleStartTour} class="gap-2" disabled={isTourActive}>
        <Navigation class="h-4 w-4" />
        <span>Start App Tour</span>
      </DropdownMenu.Item>
      <DropdownMenu.Item onclick={handleRunWizard} class="gap-2">
