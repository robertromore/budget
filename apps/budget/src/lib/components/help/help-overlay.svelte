...
{#if isActive}
  ...
  {#if !hasModalContext}
    ...
    <button
      ...
      aria-label="Close help mode"></button>
  ...
  <div
    class="pointer-events-none fixed left-1/2 z-130 -translate-x-1/2 rounded-lg bg-blue-600 px-4 py-2 text-sm text-white shadow-lg transition-[bottom] duration-200"
    ...
    <span class="opacity-80">
      ...
      <kbd class="rounded bg-white/20 px-1">Enter</kbd> view help
      <span class="mx-1 opacity-40">|</span>
