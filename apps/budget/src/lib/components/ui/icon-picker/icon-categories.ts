...
export const ICON_CATEGORIES: IconCategory[] = [
  {
    ...
    icons: [
      ...
      { name: "piggy-bank", icon: PiggyBank, keywords: ["savings", "save", "money", "piggy"] },
      {
        name: "landmark",
        icon: Landmark,
        keywords: ["bank", "building", "institution", "finance"],
      },
      ...
      { name: "receipt", icon: Receipt, keywords: ["receipt", "transaction", "purchase", "bill"] },
      {
        name: "trending-up",
        icon: TrendingUp,
        keywords: ["growth", "profit", "increase", "chart"],
      },
      {
        name: "trending-down",
        icon: TrendingDown,
        keywords: ["loss", "decrease", "decline", "chart"],
      },
      ...
      { name: "euro", icon: Euro, keywords: ["euro", "money", "currency", "eur"] },
      {
        name: "pound-sterling",
        icon: PoundSterling,
        keywords: ["pound", "money", "currency", "gbp"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    icons: [
      ...
      { name: "pizza", icon: Pizza, keywords: ["pizza", "food", "takeout", "fast food"] },
      {
        name: "shopping-cart",
        icon: ShoppingCart,
        keywords: ["groceries", "shopping", "store", "market"],
      },
  ...
  },
  {
    ...
    icons: [
      { name: "heart", icon: Heart, keywords: ["health", "medical", "wellness", "care"] },
      {
        name: "heart-pulse",
        icon: HeartPulse,
        keywords: ["health", "medical", "hsa", "healthcare", "savings"],
      },
      { name: "pill", icon: Pill, keywords: ["medicine", "pharmacy", "health", "medication"] },
      {
        name: "stethoscope",
        icon: Stethoscope,
        keywords: ["doctor", "medical", "health", "checkup"],
      },
