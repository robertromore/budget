...
import type { FilterRegistry, AmountFilterValue, RangeFilterValue, TextFilterValue } from './filter-registry';
...
export const nameContainsFilter = (
	...
	const searchValue = filterValue.caseSensitive ? filterValue.value : filterValue.value.toLowerCase();
