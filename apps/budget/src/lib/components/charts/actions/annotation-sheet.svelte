    ...
    <div class="space-y-6">
      ...
      <div class="space-y-2">
        ...
        <Textarea
          ...
          rows={4}
          maxlength={500} />
        <p class="text-muted-foreground text-xs">{note.length}/500 characters</p>
      </div>

      <!-- Flag toggle -->
      <div class="flex items-center justify-between rounded-lg border p-4">
        <div class="flex items-center gap-3">
          <Flag class="text-muted-foreground h-5 w-5" />
          <div>
            <p class="font-medium">Flag for Review</p>
            <p class="text-muted-foreground text-sm">Mark for follow-up later</p>
          </div>
        </div>
