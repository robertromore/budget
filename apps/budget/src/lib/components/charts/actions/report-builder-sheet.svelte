...
<ResponsiveSheet
  ...
  {#snippet header()}
    ...
    <Sheet.Description>
      Create a custom report from {chartSelection.count} selected month{chartSelection.count !== 1
        ? 's'
        : ''}
    </Sheet.Description>
  {/snippet}
      ...
      <div class="w-1/3 min-w-[280px] space-y-4 overflow-auto pr-2">
        ...
        {#if templatesQuery?.data && templatesQuery.data.length > 0}
          <div class="space-y-2">
            ...
            <Select.Root
              ...
              <Select.Trigger class="w-full">
                {templatesQuery.data.find((t) => t.id === selectedTemplateId)?.name ??
        ...
        <div class="space-y-2">
          ...
          <Collapsible.Root bind:open={sectionsOpen}>
            <Collapsible.Trigger
              class="hover:bg-muted/50 flex w-full items-center justify-between border p-3 {sectionsOpen
            ...
            <Collapsible.Content>
              <div class="space-y-3 rounded-b-lg border-x border-b p-3">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    bind:checked={config.sections.transactionDetails} />
                </div>
                <div class="flex items-center justify-between">
          ...
          <Collapsible.Root bind:open={chartsOpen}>
            <Collapsible.Trigger
              class="hover:bg-muted/50 flex w-full items-center justify-between border p-3 {chartsOpen
                ? 'rounded-t-lg border-b-0'
                : 'rounded-lg'}">
              <div class="flex items-center gap-2">
          ...
          <Collapsible.Root bind:open={displayOpen}>
            <Collapsible.Trigger
              class="hover:bg-muted/50 flex w-full items-center justify-between border p-3 {displayOpen
                ? 'rounded-t-lg border-b-0'
                : 'rounded-lg'}">
              <div class="flex items-center gap-2">
                <Eye class="h-4 w-4" />
          ...
          <Collapsible.Root bind:open={brandingOpen}>
            <Collapsible.Trigger
              class="hover:bg-muted/50 flex w-full items-center justify-between border p-3 {brandingOpen
                ? 'rounded-t-lg border-b-0'
                : 'rounded-lg'}">
              <div class="flex items-center gap-2">
      ...
      <div class="flex-1 overflow-hidden rounded-lg border bg-white">
        ...
        <ScrollArea class="h-[calc(100%-40px)]">
          <div
                ...
                <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                  ...
                  <div class="rounded-lg p-3" style="background-color: #f5f5f5;">
                    ...
                    <p
                      ...
                      style="color: {stats.total >= 0 ? '#16a34a' : '#dc2626'};">
                  ...
                  <div class="mb-4 space-y-2">
                    {#each categoryChartData as cat, index}
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        <div
                          class="h-5 flex-1 overflow-hidden rounded"
                          style="background-color: #f0f0f0;">
                          <div
                            class="h-full rounded"
                            style="width: {cat.normalizedAmount *
                ...
                <table class="w-full">
                  ...
                  <tbody>
                    {#each categoryBreakdown as cat}
                      {@const percentage =
                        stats.expenses > 0 ? (cat.amount / stats.expenses) * 100 : 0}
            ...
            {:else if config.sections.monthlyTrend}
              <div class="mb-6">
                ...
                <div
                  ...
                  style="border: 1px dashed #ccc; color: #666;">
            ...
            <!-- Footer -->
            <div
              class="mt-8 pt-4 text-center text-xs"
              style="border-top: 1px solid #e5e5e5; color: #666;">
