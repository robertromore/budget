  ...
  {#snippet content()}
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <div class="rounded-lg border p-3">
          <p class="text-muted-foreground text-xs">Median</p>
          <p class="text-lg font-semibold">
        ...
        <Table.Root>
          ...
          <Table.Body>
            {#each sortedPoints as point}
              ...
              {@const vsAvgPercent =
                chartSelection.averageValue !== 0 ? (vsAvg / chartSelection.averageValue) * 100 : 0}
        ...
        <div class="space-y-1.5">
          {#each sortedPoints as point}
            ...
            <div class="flex items-center gap-2">
              <span class="text-muted-foreground w-24 truncate text-xs">{point.label}</span>
              <div class="flex-1">
                <div
