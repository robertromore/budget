...
import type {ChartTypeOption} from '../config/chart-types';
...
{#if hasDataControls || hasStyleControls}
  <div class="bg-muted/30 flex items-center justify-between gap-2 rounded-lg p-3">
    <!-- ==================== PRIMARY DATA CONTROLS ==================== -->
          ...
          {#snippet header()}
            <div class="flex items-center gap-2">
              ...
              <div>
                ...
                <p class="text-muted-foreground text-sm">Customize chart appearance and behavior</p>
              </div>
            </div>
          {/snippet}
          ...
          {#snippet content()}
            <div class="space-y-8">
              ...
              {#if allowColorChange || allowCurveChange}
                <div class="space-y-4">
                  <div class="border-border border-b pb-2">
                    <h3 class="text-foreground text-sm font-semibold">Visual Styling</h3>
                  </div>
              ...
              {#if allowPointsChange}
                <div class="space-y-4">
                  <div class="border-border border-b pb-2">
                    <h3 class="text-foreground text-sm font-semibold">Point Styling</h3>
                  </div>
              ...
              {#if allowViewModeChange}
                <div class="space-y-4">
                  <div class="border-border border-b pb-2">
                    <h3 class="text-foreground text-sm font-semibold">Layout</h3>
                  </div>

                  <!-- View Mode (Combined vs Side-by-Side) -->
                  <ChartViewModeSelector bind:viewMode={selectedViewMode} {availableViewModes} />
                </div>
              {/if}
              ...
              {#if allowFontChange || allowGridChange || allowCrosshairChange || allowLabelChange}
                <div class="space-y-4">
                  <div class="border-border border-b pb-2">
                    <h3 class="text-foreground text-sm font-semibold">Axes & Grid</h3>
                  </div>
