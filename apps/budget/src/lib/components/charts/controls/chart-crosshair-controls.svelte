  ...
  <div class="space-y-3">
    ...
    <div class="space-y-3 pl-6">
      ...
      {#if showCrosshair}
        ...
        <div class="space-y-2">
          <Label class="text-muted-foreground text-sm">Crosshair Type</Label>
        ...
        <div class="space-y-2">
          <Label class="text-muted-foreground text-sm">Line Style</Label>
                ...
                <Select.Item value={option.value}>
                  <div class="flex w-full items-center justify-between">
                    ...
                    {#if option.value === 'solid'}
                      <div class="ml-2 h-0.5 w-8 bg-current"></div>
                    {:else if option.value === 'dashed'}
                      <div
                        class="ml-2 h-0.5 w-8"
                        style="background-image: repeating-linear-gradient(90deg, currentColor 0, currentColor 4px, transparent 4px, transparent 7px);">
                      </div>
                    {:else if option.value === 'dotted'}
                      <div
                        class="ml-2 h-0.5 w-8"
                        style="background-image: repeating-linear-gradient(90deg, currentColor 0, currentColor 2px, transparent 2px, transparent 4px);">
                      </div>
                    {/if}
                  </div>
                </Select.Item>
