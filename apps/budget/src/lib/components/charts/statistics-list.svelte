      ...
      <div class="bg-card divide-y rounded-lg border">
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Mean spending per month</p>
          </div>
        ...
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Middle value (less affected by outliers)</p>
          </div>
          <p class="text-sm font-semibold tabular-nums">
        ...
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Sum across {stats.summary.count} months</p>
          </div>
          <div class="text-right">
            <p class="text-sm font-semibold tabular-nums">
      ...
      <div class="bg-card divide-y rounded-lg border">
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Overall spending trajectory</p>
          </div>
          <p
        ...
        {#if stats.trend.growthRate !== null}
          <div class="flex items-center justify-between px-4 py-3">
            <div>
              ...
              <p class="text-muted-foreground text-xs">Compound growth percentage</p>
            </div>
            <p
        ...
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Average change per month</p>
          </div>
          <p
            class="text-sm font-semibold tabular-nums"
      ...
      <div class="bg-card divide-y rounded-lg border">
        ...
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Difference between highest and lowest</p>
          </div>
          <p class="text-sm font-semibold tabular-nums">
        ...
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Lower quartile boundary</p>
          </div>
          <p class="text-sm font-semibold tabular-nums">
        ...
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Upper quartile boundary</p>
          </div>
          <p class="text-sm font-semibold tabular-nums">
        ...
        <div class="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p class="text-muted-foreground text-xs">Spending variability</p>
          </div>
          <p class="text-sm font-semibold tabular-nums">
          ...
          <div class="flex items-center justify-between px-4 py-3">
            <div>
              ...
              <p class="text-muted-foreground text-xs">
                Relative variability (lower is more consistent)
              </p>
            </div>
            <p class="text-sm font-semibold tabular-nums">
          ...
          {#if stats.comparison.vsHistoricalAvg !== null}
            <div class="flex items-center justify-between px-4 py-3">
              <div>
                ...
                <p class="text-muted-foreground text-xs">Compared to all-time average</p>
              </div>
              <div class="text-right">
                <p
                  class="text-sm font-semibold tabular-nums"
          ...
          {#if stats.comparison.vsBudgetTarget !== null}
            <div class="flex items-center justify-between px-4 py-3">
              <div>
                ...
                <p class="text-muted-foreground text-xs">Monthly avg vs monthly budget</p>
              </div>
              <div class="text-right">
                <p
                  class="text-sm font-semibold tabular-nums"
          ...
          {#if stats.comparison.vsLastYearTotal !== null}
            <div class="flex items-center justify-between px-4 py-3">
              <div>
                ...
                <p class="text-muted-foreground text-xs">Year-over-year comparison</p>
              </div>
              <div class="text-right">
                <p
                  class="text-sm font-semibold tabular-nums"
