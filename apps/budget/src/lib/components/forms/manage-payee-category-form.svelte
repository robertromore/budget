...
<form method="post" use:enhance class="space-y-6">
	...
	<Card.Root>
		<Card.Header class="pb-4">
			...
			<Card.Description>
				Enter the basic details for your payee category.
			</Card.Description>
		</Card.Header>
	...
	<Card.Root>
		<Card.Header class="pb-4">
			...
			<Card.Description>
				Customize the icon and color for this category.
			</Card.Description>
		</Card.Header>
		<Card.Content class="space-y-4">
					...
					<AlertDialog.Content>
						<AlertDialog.Header>
							...
							<AlertDialog.Description>
								This will remove the category and unassign all payees from it. Payees will not
								be deleted.
							</AlertDialog.Description>
						</AlertDialog.Header>
						<AlertDialog.Footer>
