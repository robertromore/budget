		...
		<Card.Content class="space-y-4">
			...
			<div class="grid grid-cols-3 gap-4">
				...
				<div class="space-y-1">
					...
					<div
						class="text-sm font-semibold {forecast.projectedBalance < 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}"
					>
				...
				<div class="space-y-2">
					...
					<div class="space-y-2">
						{#each forecast.scheduledExpenses as expense}
							<div
								class="flex items-center justify-between rounded-md border bg-background/50 p-2 text-sm"
							>
