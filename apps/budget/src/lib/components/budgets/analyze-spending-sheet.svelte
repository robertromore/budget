      ...
      <div class="flex flex-col items-center justify-center py-12 text-center">
        {#if analysisResult.count > 0}
          ...
          <p class="text-muted-foreground mt-2">
            Found {analysisResult.count} recommendation{analysisResult.count !== 1 ? 's' : ''} based on
        ...
        {:else}
          ...
          <h3 class="text-lg font-semibold">Analysis Complete</h3>
          <p class="text-muted-foreground mt-2">
            No new recommendations found. Your budgets are already well-optimized, or try adjusting
