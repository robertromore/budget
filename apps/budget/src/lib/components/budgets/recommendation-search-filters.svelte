<script lang="ts">
  ...
  import type {RecommendationType, RecommendationStatus, RecommendationPriority} from '$lib/schema/recommendations';
...
<div class="space-y-3">
  ...
  <div class="space-y-2">
    <div class="flex items-center justify-between">
      ...
      <span class="text-xs text-muted-foreground">{minConfidence}%</span>
    </div>
    <Slider
