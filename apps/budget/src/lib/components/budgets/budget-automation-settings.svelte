...
<div class="space-y-6">
  ...
  <Card.Root>
    <Card.Header>
      ...
      <Card.Description>
        Enable or disable automatic budget group operations
      </Card.Description>
    </Card.Header>
    <Card.Content class="space-y-6">
      ...
      <div class="flex items-start justify-between">
        <div class="space-y-1 flex-1">
          <Label for="auto-create-groups" class="text-base font-medium">
            Auto-create groups
          </Label>
          <p class="text-sm text-muted-foreground">
        ...
        <Switch
          ...
          bind:checked={localSettings.autoCreateGroups}
        />
      </div>
      ...
      <div class="flex items-start justify-between">
        <div class="space-y-1 flex-1">
          <Label for="auto-assign-groups" class="text-base font-medium">
            Auto-assign budgets
          </Label>
          <p class="text-sm text-muted-foreground">
        ...
        <Switch
          id="auto-assign-groups"
          bind:checked={localSettings.autoAssignToGroups}
        />
      </div>
      ...
      <div class="flex items-start justify-between">
        ...
        <Switch
          id="auto-adjust-limits"
          bind:checked={localSettings.autoAdjustGroupLimits}
        />
      </div>
      ...
      <div class="flex items-start justify-between">
        ...
        <Switch
          id="enable-smart-grouping"
          bind:checked={localSettings.enableSmartGrouping}
        />
      </div>
    </Card.Content>
  </Card.Root>
  ...
  <Card.Root>
    <Card.Header>
      ...
      <Card.Description>
        Control when automations should require confirmation
      </Card.Description>
    </Card.Header>
    <Card.Content class="space-y-6">
      ...
      <div class="space-y-3">
        ...
        <Select.Root
          type="single"
          bind:value={localSettings.requireConfirmationThreshold}
        >
      ...
      <!-- Grouping strategy -->
      <div class="space-y-3">
        <Label for="grouping-strategy" class="text-base font-medium">
          Grouping strategy
        </Label>
        <Select.Root
          type="single"
          bind:value={localSettings.groupingStrategy}
        >
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between">
          <Label for="min-similarity" class="text-base font-medium">
            Minimum confidence
          </Label>
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between">
          <Label for="min-group-size" class="text-base font-medium">
            Minimum group size
          </Label>
  ...
  <Card.Root class="bg-muted/50">
    <Card.Content class="pt-6">
      <div class="flex gap-3">
        <Sparkles class="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
        <div class="space-y-1">
          ...
          <p class="text-sm text-muted-foreground">
            ...
            If automation is enabled and confidence is high enough, groups will be created automatically.
            You can always review and rollback automated actions in the Activity Log.
          </p>
        </div>
      </div>
    </Card.Content>
