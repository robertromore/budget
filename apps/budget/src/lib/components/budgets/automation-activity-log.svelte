    ...
    <Card.Header>
      <div class="flex items-center justify-between">
        <div>
          ...
          <Card.Description>Track all automated actions and rollback if needed</Card.Description>
        </div>
        {#if onRefresh}
              ...
              <Table.Cell>
                <div class="flex items-center gap-2">
                  {#if getActionIcon(activity.actionType)}
                    ...
                    <ActionIcon class="text-muted-foreground h-4 w-4" />
                  {/if}
              ...
              <Table.Cell class="text-right">
                ...
                {:else if activity.status === 'failed'}
                  <Button
                    ...
                    size="sm"
                    disabled
                    class="text-muted-foreground cursor-not-allowed gap-1.5">
      ...
      <Card.Content class="pt-6">
        <div class="grid grid-cols-4 gap-4">
          <div class="text-center">
            ...
            <div class="text-muted-foreground text-xs">Successful</div>
          </div>
          <div class="text-center">
            <div class="text-2xl font-bold">
          ...
          <div class="text-center">
            ...
            <div class="text-muted-foreground text-xs">Rolled Back</div>
          </div>
        </div>
      </Card.Content>
    </Card.Root>
