    ...
    <div class="flex flex-col gap-4">
      ...
      <button
        ...
        <div class="flex items-start gap-4">
          <div
            class="bg-primary/10 group-hover:bg-primary/20 flex h-12 w-12 shrink-0 items-center justify-center rounded-lg transition-colors">
      ...
      <button
        type="button"
        class="group rounded-lg border p-5 text-left transition-all {tellerAvailable()
      ...
      <div class="bg-muted/50 mt-2 rounded-lg border p-4">
        ...
        <div class="text-muted-foreground space-y-2 text-sm">
          <p>
            <strong class="text-foreground">SimpleFIN</strong> is best for most users. It has the widest
            bank coverage and uses MX as the backend, ensuring reliable data access.
          </p>
          <p>
            <strong class="text-foreground">Teller</strong> is a good free alternative if your bank is
            supported. It connects directly to bank APIs for real-time updates.
          </p>
        </div>
      </div>
    </div>
