...
import type { ExternalAccount } from '$core/schema/account-connections';
...
function setupTellerConnect() {
  ...
  const environment =
    dbSettings?.environment || import.meta.env.VITE_TELLER_ENVIRONMENT || 'sandbox';

  if (!applicationId) {
    connectError =
      'Teller application ID not configured. Please configure it in Settings > Bank Connections.';
    return;
  }
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="space-y-4">
          ...
          <div
            ...
            <div class="flex gap-3">
              <Zap class="h-5 w-5 shrink-0 text-info" />
              <div class="text-sm">
                <p class="text-info-fg font-medium">Secure Connection</p>
      ...
      {:else if currentStep === 'confirm'}
        ...
        <div class="space-y-4">
          ...
          <div
            class="bg-success-bg rounded-lg border border-success/20 p-4">
            <div class="flex gap-3">
