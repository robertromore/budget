    ...
    {#if transformedChartData.length > 0}
      ...
      <div class="grid grid-cols-3 gap-2 text-xs">
        <div class="rounded-lg bg-green-50 p-2 text-center dark:bg-green-950/20">
          <div class="font-medium text-green-600">Income</div>
        ...
        <div class="rounded-lg bg-red-50 p-2 text-center dark:bg-red-950/20">
          <div class="font-medium text-red-600">Expenses</div>
        ...
        <div
          class="rounded-lg p-2 text-center {netAmount >= 0
            ? 'bg-blue-50 dark:bg-blue-950/20'
            : 'bg-orange-50 dark:bg-orange-950/20'}">
          <div
            class="flex items-center justify-center gap-1 {netAmount >= 0
              ? 'text-blue-600'
              : 'text-orange-600'}">
            {#if netAmount > 0}
          ...
          <div
            class="font-semibold {netAmount >= 0
      ...
      {#if config.size === 'large'}
        <div class="flex items-center justify-center gap-4 text-xs">
          <div class="flex items-center gap-1">
            <div class="h-2 w-3 rounded bg-green-500"></div>
            <span class="text-muted-foreground">Income</span>
          </div>
          <div class="flex items-center gap-1">
            <div class="h-2 w-3 rounded bg-red-500"></div>
