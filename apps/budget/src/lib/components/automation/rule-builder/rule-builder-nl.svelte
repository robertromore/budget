...
<div class={cn('bg-background flex flex-col gap-6 rounded-lg border p-6', className)}>
  <!-- Section 1: Trigger -->
  <section>
    <NlTriggerRow
  ...
  <section class="space-y-3">
    <div class="space-y-2">
      ...
      {#if ruleConfig.actions.length === 0}
        <div class="text-muted-foreground rounded-md bg-orange-50/50 px-3 py-4 text-center text-sm">
