...
const currentOperator = $derived(condition.operator ? operatorInfo[condition.operator] : null);
...
<div class="group bg-muted/30 flex flex-wrap items-center gap-2 rounded-md px-3 py-2">
  <!-- Field Select -->
