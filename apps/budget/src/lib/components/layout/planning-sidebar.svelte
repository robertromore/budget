            ...
            <Sidebar.MenuButton isActive={goalsActive}>
              {#snippet child({ props })}
                <a
                  href="/goals"
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, goalsActive && ACTIVE_NAV.planning]}>
            ...
            <Sidebar.MenuButton isActive={schedActive}>
              {#snippet child({ props })}
                <a
                  href="/schedules"
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, schedActive && ACTIVE_NAV.planning]}>
            ...
            <Sidebar.MenuButton isActive={calActive}>
              {#snippet child({ props })}
                <a
                  ...
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, calActive && ACTIVE_NAV.planning]}>
