            ...
            <Sidebar.MenuButton isActive={dashActive}>
              {#snippet child({ props })}
                <a
                  href="/price-watcher"
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, dashActive && ACTIVE_NAV.priceWatcher]}>
            ...
            <Sidebar.MenuButton isActive={prodActive}>
              {#snippet child({ props })}
                <a
                  ...
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, prodActive && ACTIVE_NAV.priceWatcher]}>
            ...
            <Sidebar.MenuButton isActive={cmpActive}>
              {#snippet child({ props })}
                <a
                  ...
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, cmpActive && ACTIVE_NAV.priceWatcher]}>
            ...
            <Sidebar.MenuButton isActive={alertsActive}>
              {#snippet child({ props })}
                <a
                  ...
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, alertsActive && ACTIVE_NAV.priceWatcher]}>
            ...
            <Sidebar.MenuButton isActive={histActive}>
              {#snippet child({ props })}
                <a
                  ...
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, histActive && ACTIVE_NAV.priceWatcher]}>
            ...
            <Sidebar.MenuButton isActive={setActive}>
              {#snippet child({ props })}
                <a
                  ...
                  {...props}
                  class={['flex items-center gap-3', BASE_NAV, setActive && ACTIVE_NAV.priceWatcher]}>
