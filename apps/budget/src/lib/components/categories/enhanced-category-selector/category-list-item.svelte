...
<div
  ...
  <div class="flex shrink-0 items-center gap-2">
    {#if category.categoryColor}
      <div class="h-3 w-1 rounded-full" style={`background-color: ${category.categoryColor};`}>
      </div>
    {/if}
    <div
      class={cn(
      ...
      style={category.categoryColor ? `background-color: ${category.categoryColor}20;` : undefined}>
      <IconComponent
        class={cn(
