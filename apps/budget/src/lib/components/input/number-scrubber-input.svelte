...
<div bind:this={containerRef} class={cn('relative', className)}>
  ...
  {#if isFocused || isDragging}
    ...
    {#if isDragging && activeValue !== null}
      <div
        class={cn(
          'bg-primary text-primary-foreground pointer-events-none absolute top-full left-1/2 z-20 mt-14 flex h-10 -translate-x-1/2 items-center justify-center rounded-lg font-bold shadow-lg',
