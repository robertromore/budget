...
const brushLeft = $derived(
  brushStart !== null && brushEnd !== null ? Math.min(brushStart, brushEnd) : null
);
const brushRight = $derived(
  brushStart !== null && brushEnd !== null ? Math.max(brushStart, brushEnd) : null
);
