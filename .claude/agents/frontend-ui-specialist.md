...
- The monorepo UI component architecture and how to properly organize UI components within `apps/budget/src/lib/components/ui/`
...
- Organize components in `apps/budget/src/lib/components/ui/` following the established folder structure
...
Your goal is to create beautiful, functional, and accessible user interfaces that leverage the full power of Shadcn Svelte and modern web technologies while maintaining clean, maintainable code within the monorepo UI structure.
